          ...
          children: [
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    Image.network(subject.imageUrl,
                      width: 70,
                      height: 70,),
                    SizedBox(width: 10,),
                    Text(subject.name,style: getSemiBoldStyle(color: AppColors.black,fontSize: FontSize.s20),),
                    Spacer(),
                    Text(
                ...
                Row(
                  children: [
                    Text(exam.title, style: getMediumStyle(color: AppColors.black,fontSize: FontSize.s18),),
                    SizedBox(width: 5),
                    Container(
                      width: 1,
                      height: 25,
                    ...
                    Text(
                      ...
                      style: getRegularStyle(color: AppColors.gray, fontSize: 16),
                    ),
                  ],
                ),
              ],
           ...
           Divider(
            ...
            Padding(padding: EdgeInsets.all(20),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text("Instructions",style: getMediumStyle(color: AppColors.black,fontSize: FontSize.s18),),
                  DottedListItem(),
                  DottedListItem(),
                  DottedListItem(),
                  DottedListItem(),
